...
export const TR = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr ref={ref} className={cn("border-b border-neutral-200 transition-colors hover:bg-neutral-50", className)} {...props} />
  )
);
TR.displayName = "TR";
...
export const TH = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th ref={ref} className={cn("h-10 px-3 text-left align-middle text-xs font-semibold text-neutral-500", className)} {...props} />
  )
);
TH.displayName = "TH";
...
export const TD = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <td ref={ref} className={cn("px-3 py-3 align-middle text-neutral-700", className)} {...props} />
  )
);
TD.displayName = "TD";
